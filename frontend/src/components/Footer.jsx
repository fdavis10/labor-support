...
const socialLinks = [
  {
    href: 'https://vk.ru/trudovayaopora',
    label: 'ВКонтакте',
    icon: 'vk',
  },
  {
    href: 'https://t.me/ProfShering',
    label: 'Telegram',
    icon: 'telegram',
  },
  {
    href: 'mailto:trudovayaopora@mail.ru',
    label: 'Email',
    icon: 'mail',
  },
]
        ...
        <div className={styles.social}>
          {socialLinks.map(({ href, label, icon }) => (
            ...
            >
              ...
              {icon === 'mail' && <Mail className={styles.socialIcon} size={22} strokeWidth={2} />}
            </a>
          ))}
        </div>
