...
const categories = [
  {
    ...
    description: 'Разработчики, тестировщики, аналитики, DevOps — под ваш стек и проект.',
    image: '/images/it.svg',
    featured: true,
  },
  {
    ...
    description: 'Бухгалтеры, главбухи, экономисты для учёта и отчётности.',
  ...
  },
  {
    id: 'construction',
    title: 'Строительство',
    description: 'Инженеры, прорабы, рабочие специальности для объектов.',
    image: '/images/construction.svg',
    featured: false,
  },
  {
    id: 'office',
    title: 'Офисный персонал',
    description: 'Администраторы, HR, секретари, помощники руководителя.',
  ...
  },
  {
    ...
    description: 'Кладовщики, водители, комплектовщики для складов и доставки.',
  ...
  },
  {
    ...
    description: 'Подбор под любые задачи: производство, торговля, услуги.',
      ...
      <div className={styles.container}>
        <div className={styles.head}>
          ...
          <p className={styles.lead}>
            Один специалист или команда — на проект или на постоянной основе. Быстро и без лишних формальностей.
          </p>
        </div>
